...
/// A thinking block with content and signature (Anthropic extended thinking).
///
/// When using extended thinking with tool use, Anthropic requires passing back
/// the complete thinking block including both the thinking content and the signature.
/// The signature is used to verify that thinking blocks were generated by Claude.
...
pub enum ContentPart {
	...
	/// Thinking block with content and signature (Anthropic extended thinking).
	#[from]
	Thinking(Thinking),
}
